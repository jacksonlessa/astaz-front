...
const variantStyles = {
  primary:
    "bg-primary text-secondary hover:bg-primary-light focus-visible:ring-primary/50",
  outline:
    "border border-primary/40 text-primary hover:bg-primary/10 focus-visible:ring-primary/30",
  ghost:
